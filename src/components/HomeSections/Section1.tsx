...
export default function Section1() {
  return (
    <div className="w-full h-screen bg-[url('assets/araratsky.jpg')] bg-center bg-cover flex flex-col px-[7%] pt-[6%]">
        <div className="w-full h-[30%] flex justify-between items-center p-[1%]a ">
          <div className="w-[20%]  h-full backdrop-blur-2xl rounded-3xl bg-white/20 shadow-lg p-[1%] flex flex-col gap-[12%]">
          ...
          <div className="w-[40%] h-full p-[1%] rounded-3xl flex justify-center flex-col">
        ...
        <div className="w-full h-[70%] flex justify-center items-center gap-[1%]">
          <div className="w-[50%] h-full flex flex-col ">
            ...
            <div className="w-full h-[23%] flex justify-start items-center p-[4%] gap-[2%]">
